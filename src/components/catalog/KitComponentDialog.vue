  ...
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    <DialogContent class="sm:max-w-[440px]">
      <DialogHeader>
        ...
        <DialogDescription class="text-[12px] text-[#888] dark:text-[#888899]">Define a kit component with part details.</DialogDescription>
      </DialogHeader>

      <div class="grid gap-4 py-2">
        <div class="grid grid-cols-2 gap-3">
          <div>
            <label class="text-[11px] text-[#888] dark:text-[#888899] uppercase tracking-wider mb-1 block">Sequence</label>
            <Input v-model.number="form.sequence" type="number" class="h-8 text-[13px] border-[#ddd] dark:border-[#2a2a40]" />
          </div>
          <div>
        ...
        <div class="grid grid-cols-3 gap-3">
          ...
          <div>
            ...
            <Input v-model="form.uom" class="h-8 text-[13px] border-[#ddd] dark:border-[#2a2a40]" />
          </div>
          <div>
