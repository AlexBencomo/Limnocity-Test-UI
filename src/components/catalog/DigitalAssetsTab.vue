...
<template>
  <div>
    ...
    <!-- Upload zone -->
    <div
      class="border border-dashed border-[#ddd] rounded-sm p-5 text-center hover:border-[#3bbfa0] transition-colors cursor-pointer mb-4"
      @click="openAdd"
    >
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
      <div
        ...
        :key="i"
        class="border border-[#eee] rounded-sm p-3 hover:border-[#3bbfa0] transition-colors cursor-pointer group relative"
      ...
      >
        ...
        <button class="absolute top-2 right-2 h-6 w-6 flex items-center justify-center text-[#aaa] hover:text-[#444] opacity-0 group-hover:opacity-100 transition-opacity">
